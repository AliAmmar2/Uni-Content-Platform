...
import {
  STUDENT_KEY,
  studentReducers
} from './student/+state/student.reducer';

import {
  STUDENT_DETAILS_KEY,
  studentDetailsReducers
} from './student/+state/student-details.reducer';
...
import {
  FACULTY_KEY,
  facultyReducers
} from './faculty/+state/faculty.reducer';

import {
  FACULTY_DETAILS_KEY,
  facultyDetailsReducers
} from './faculty/+state/faculty-details.reducer';
...
import {
  MAJOR_KEY,
  majorReducers
} from './major/+state/major.reducer';

import {
  MAJOR_DETAILS_KEY,
  majorDetailsReducers
} from './major/+state/major-details.reducer';
...
} from './courses/+state/course-details.reducer';
...
import {
  ADMIN_KEY,
  adminReducer
} from './portal-admin/+state/admin.reducer';

import {
  ADMIN_DETAILS_KEY,
  adminDetailsReducers
} from './portal-admin/+state/admin-details.reducer';
