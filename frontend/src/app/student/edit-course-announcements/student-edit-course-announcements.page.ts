...
@Component({
  ...
  templateUrl: './student-edit-course-announcements.page.html',
  styleUrl: './student-edit-course-announcements.page.scss'
})
export class StudentEditCourseAnnouncementsPage implements OnInit, OnDestroy {
      ...
      this.courseAnnouncementDetailsSelected$.subscribe({
        next: (announcementDetailsState) => {
          ...
          if (
            ...
            if (!announcement || announcement.id !== this.announcementId) {
              return;
            }
