...
import { selectAllPendingMaterials, selectMaterialDetails } from '../../material/+state/material.selector';
...
@Component({
  selector: 'app-student-pending-materials',
  standalone: true,
  imports: [
    CommonModule,
    LetDirective,
  ...
  templateUrl: './student-pending-materials.page.html',
  styleUrl: './student-pending-materials.page.scss'
})
export class StudentPendingMaterialsPage implements OnInit, OnDestroy {
