...
@Component({
  ...
  templateUrl: './course-announcement-details.page.html',
  styleUrl: './course-announcement-details.page.scss'
})
export class CourseAnnouncementDetailsPage implements OnInit, OnDestroy {
  ...
  public async downloadImage(
    ...
    try {
      ...
      link.href = blobUrl;
      link.download = filename || 'announcement-image';
